...
Informations about the spatial and temporal changes between the frames of each reference video are calculated with SITI \cite{web:SITI}, a command-line-based tool that refers to ITU-T P.910, and diagrammed in Figure \ref{fig:SITI}. As expected, Air Show includes the smallest spatial and temporal changes in comparison with the other reference videos due to the slightly changing and low complex scenario. Whereas the cartoon Big Buck Bunny shows a large range of temporal informations by reason of camera movement and Snow Monkeys the highest spatial informations according to fine structures and details.

\begin{figure}[!t]
	\centering
	\includegraphics[width=3.5in]{SITI}
	\caption{Spatial and temporal informations of the reference video files. Each cross represents one frame}
	\label{fig:SITI}
\end{figure}
